...
mkdir gif_top_land
mkdir mp4_common_land
mkdir mp4_common_land\zz_temp\
mkdir mp4_common_land\mp4_top_land\
mkdir mp4_common_land\mp4_common_land\ 
mkdir mp4_common_land\mp4_anim_land\ 
mkdir mp4_common_land\mp4_hua_land\ 
...
mkdir mp4_common_port\mp4_top_port\
mkdir mp4_common_port\mp4_common_port\ 
mkdir mp4_common_port\mp4_anim_port\ 
mkdir mp4_common_port\mp4_hua_port\ 
